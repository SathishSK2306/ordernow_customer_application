...
const Navbar = () => {
  ...
  const navItems = ["Home", "Menu", "cart", "payment", "history"];
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="hidden md:block bg-gray-700 hover:bg-gold-600 text-white px-4 py-2 rounded-md font-medium transition-colors"
        >
          Login
        </motion.button>
      </div>
